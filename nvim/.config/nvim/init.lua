...
-- Poner Kitty opaco al entrar en Neovim
vim.api.nvim_create_autocmd({ "VimEnter" }, {
  callback = function()
    -- Envía la secuencia de escape a Kitty para poner opacidad a 1 (Sólido)
    io.write("\x1b]a1\x1b\\")
  end,
})

-- Restaurar la transparencia de Kitty al salir de Neovim
vim.api.nvim_create_autocmd({ "VimLeave" }, {
  callback = function()
    -- Envía la secuencia para volver a la opacidad por defecto ("d")
    io.write("\x1b]ad\x1b\\")
  end,
})
